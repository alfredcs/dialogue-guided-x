...
from langchain_community.chat_models import (ChatOpenAI, BedrockChat, ChatVertexAI)
...
with st.sidebar:
    ...
    option = st.selectbox('Choose LLM Model',('anthropic.claude-v2:1', 'gemini-pro', 'gemini-pro-vision', 'gpt-4-1106-preview', 'gpt-4-vision-preview', 'mistral-8x7b'))
    ...
    if upload_docs:
        ...
        print(f'Docs:{docs} and arvbg sizes:{avg_doc_length}')
